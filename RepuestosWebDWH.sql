...
--Metadata
	...
	EXEC sys.sp_addextendedproperty 
     ...
     @value = N'La dimension geografia provee una vista desnormalizada, integrará País, Region y Ciudad, dejando todo en una única dimensión para un modelo estrella', 
     @level0type = N'SCHEMA', 
	...
	EXEC sys.sp_addextendedproperty 
     @name = N'Desnormalizacion', 
     @value = N'La dimension clientes tendrá información de los clientes en una sola dimensión para un modelo estrella', 
     @level0type = N'SCHEMA', 
     @level0name = N'Dimension', 
     @level1type = N'TABLE', 
	...
	EXEC sys.sp_addextendedproperty 
     @name = N'Desnormalizacion', 
     @value = N'La dimension partes tendrá información las tablas de Partes, Linea y Categoria en una sola dimensión para un modelo estrella', 
     @level0type = N'SCHEMA', 
     @level0name = N'Dimension', 
     @level1type = N'TABLE', 
     @level1name = N'Partes';
